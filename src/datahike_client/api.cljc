...
#_(defn- ^:no-doc date? [d]
    #?(:cljs (instance? js/Date d)
       :clj  (instance? Date d)))

#_(def ^{:arglists '([db time-point])
...
#_(def ^{:arglists '([conn callback] [conn key callback])
